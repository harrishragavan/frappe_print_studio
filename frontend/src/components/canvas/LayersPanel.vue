<template>
  <div class="w-full h-full bg-studio-panel border-r border-studio-border flex flex-col select-none">
    ...
    <div class="p-4 border-b border-studio-border flex justify-between items-center shrink-0">
      <h3 class="text-[10px] font-black text-studio-textSecondary uppercase tracking-widest font-serif">Layers</h3>
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar p-3 space-y-2">
      <div class="space-y-1">
        <!-- Root node -->
        <div class="flex items-center space-x-1.5 py-1 px-1.5 text-xs text-studio-text font-black uppercase tracking-wider font-serif">
        ...
        <div class="pl-4 space-y-0.5">
          ...
          >
            <div class="flex items-center space-x-2.5 truncate">
              ...
              <span class="truncate capitalize text-studio-textSecondary group-hover:text-studio-text transition font-serif">{{ formatRegionName(region) }}</span>
            </div>
