<template>
  <div class="flex-1 flex flex-col lg:flex-row min-h-0 bg-studio-bg select-none">
    ...
    <div class="flex-1 flex flex-col min-h-[400px] lg:h-full border-r border-studio-border">
      ...
      <div class="flex-1 min-h-0 bg-studio-bg p-4 relative flex flex-col">
        ...
        <textarea 
          ...
          class="flex-1 w-full bg-studio-panel border border-studio-border rounded-xl p-4 font-mono text-xs text-studio-text focus:outline-none focus:border-studio-accent/70 focus:ring-1 focus:ring-studio-accent/30 leading-relaxed resize-none custom-scrollbar"
        ></textarea>
    ...
    <div class="flex-1 flex flex-col min-h-[400px] lg:h-full bg-studio-bg relative p-4">
      <div class="text-[9px] uppercase tracking-widest text-studio-textMuted font-bold mb-2 pb-1 border-b border-studio-border flex justify-between shrink-0">
        <span>Template Render Preview</span>
        <span>A4 Portrait</span>
      </div>
      <div class="flex-1 bg-white rounded-xl border border-studio-border overflow-hidden shadow-2xl relative">
        <iframe 
